  ...
  <div className="w-full pt-4 pr-5 pb-6 pl-5 mt-0 mr-auto mb-0 ml-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16
    ...
    <div className="flex flex-col items-center sm:px-5 md:flex-row">
      <div className="flex flex-col items-start justify-center w-full h-full pt-6 pr-0 pb-6 pl-0 mb-6 md:mb-0 md:w-1/2">
        <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pr-10 lg:pr-16
          ...
          <a className="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl">In Garg Clinic Best Health care service available</a>
          <div className="pt-2 pr-0 pb-0 pl-0">
            <p className="text-sm font-medium inline">Owner:</p>
            <a className="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1 underline">DR. ASHISH GARG </a>
      ...
      <div className="w-full md:w-1/2">
        <div className="block">
          <img
              src={gargad} className="object-cover rounded-lg max-h-64 sm:max-h-96 btn- w-full h-full"/>
        </div>
      </div>
    </div>
    <div className="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
      <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
        <img
            src={gallery4} className="object-cover w-full mb-2 overflow-hidden rounded-lg shadow-sm max-h-56 btn-"/>
        <p className="bg-red-600 flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
            rounded-full uppercase inline-block">Garg Clinic</p>
        <a className="text-lg font-bold sm:text-xl md:text-2xl">24X7 Intensive Care Unit</a>
      ...
      <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
        <img
            src={gallery3} className="object-cover w-full mb-2 overflow-hidden rounded-lg shadow-sm max-h-56 btn-"/>
     <p className="bg-red-600 flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
            rounded-full uppercase inline-block">Garg Clinic</p>
        <a className="text-lg font-bold sm:text-xl md:text-2xl">Emergency Ward</a>
      ...
      <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
        <img
            src={gallery2} className="object-cover w-full mb-2 overflow-hidden rounded-lg shadow-sm max-h-56 btn-"/>
          <p className="bg-red-600 flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
            rounded-full uppercase inline-block">Garg Clinic</p>
  ...
  <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
      <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
        <div className="md:5/12 lg:w-5/12">
          <img src={featureimg1} alt="image" loading="lazy" width="400" height="500"/>
        </div>
        <div className="md:7/12 lg:w-6/12">
          <h2 className="text-2xl text-gray-900 font-bold md:text-4xl">About Us </h2>
          <p className="mt-6 text-gray-600">Garg Clinics provide affordable and quality healthcare to rural and semi-urban areas in Chandigarh. We strive to make our clinic a place where patients can always feel confident that they are receiving the best care in a friendly atmosphere. By understanding what is most important to you and your family, we’re able to deliver better quality healthcare that is also convenient.</p>
          <p className="mt-4 text-gray-600">  Garg Clinics offers primary care for individuals and families across all ages, genders, and diseases. Our primary motive is to deliver world-className healthcare facilities that ensure quality,affordability,accessibility through a patient centric model.</p>
        </div>
      </div>
  </div>
</div>
