  ...
  return (
    <>
      ...
      <div className="h-screen md:flex mb-10">
        <div className="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-red-900 to-red-500 i justify-around items-center hidden">
          <div>
            ...
            <Link
              to="/businesses"
              type="submit"
              className="block w-28 bg-white text-black-800 mt-4 py-2  rounded-2xl font-bold mb-2 text-center"
            >
              Business
            </Link>
          </div>
        ...
        {islogin ? (
          <>
            <div className="flex md:w-1/2 justify-center py-10 mt-52 items-center bg-white">
              <form
                onSubmit={addBusinesshandleSubmit}
