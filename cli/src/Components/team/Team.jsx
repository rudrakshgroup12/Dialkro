          ...
          <div className="lg:grid lg:grid-cols-2">
            <div className="py-24 px-10 lg:px-0 max-w-3xl lg:max-w-md mx-auto">
              ...
              <p className="text-gray-300 mt-5">
                DialKro is a dynamic social media marketing company committed to
                providing innovative solutions to enhance your online presence.
                Our team consists of creative strategists, digital experts, and
                social media enthusiasts who are passionate about driving
                results for our clients. With a focus on cutting-edge strategies
                and personalized approaches, we help businesses connect with
                their target audience, build meaningful relationships, and
        ...
        <section className="bg-white dark:bg-gray-900 teamback">
          <div className="container px-6 py-10 mx-auto">
            ...
            <p className="max-w-5xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
              Our dedicated team members have gained expertise in providing
              customized web design and development solutions to help our
              customers. However, this helps to create an outstanding web
              presence that could go along with the identity of their company.
              The team of Dialkro is skilled and they are capable to develop any
              kind of web program. Here is a brief introduction of our expert
              team that works for the satisfaction of clients.
            </p>
            ...
            <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
              ...
              <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-red-900 rounded-xl">
                <img
                  className="object-contain w-32 h-32 rounded-full ring-4 ring-gray-300"
                  src={komal}
                  alt=""
                />
