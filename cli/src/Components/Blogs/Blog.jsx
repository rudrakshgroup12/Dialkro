...
function Blog() {
  ...
  return (
    <Layout>
      <div>
        <div className="flex justify-center items-center dark:bg-neutral-800">
                  ...
                  <div className="sm:w-1/2 sm:mt-0 mt-4 relative">
                    <div>
                      ...
                      <div className="absolute bottom-0 left-0 p-6">
                        ...
                        <p className="text-base leading-4 text-white mt-2">
                          {" "}
                          How Businesses and Affiliates Collaborate for Success
                        </p>
                        <a
                          href="javascript:void(0)"
                          className="focus:outline-none focus:underline flex items-center mt-4 cursor-pointer text-white hover:text-gray-200 hover:underline"
                ...
                <div className="relative">
                  <div>
                    ...
                    <div className="absolute bottom-0 left-0 md:p-10 p-6">
                      ...
                      <p className="text-base leading-4 text-white mt-2">
                        Globally can be an exciting but challenging endeavor
                      </p>
                      <a
                        href="javascript:void(0)"
                        className="focus:outline-none focus:underline flex items-center mt-4 cursor-pointer text-white hover:text-gray-200 hover:underline"
                  ...
                  <div className="relative w-full">
                    <div>
                      ...
                      <div className="absolute bottom-0 left-0 p-6">
                        ...
                        <p className="text-base leading-4 text-white mt-2">
                          AI works through a combination of algorithms and data.
                        </p>
                        <a
                          href="javascript:void(0)"
                          className="focus:outline-none focus:underline flex items-center mt-4 cursor-pointer text-white hover:text-gray-200 hover:underline"
                  ...
                  <div className="relative w-full sm:mt-0 mt-4">
                    <div>
                      ...
                      <div className="absolute bottom-0 left-0 p-6">
                        ...
                        <p className="text-base leading-4 text-white mt-2">
                          To protect yourself from heart attacks, it's crucial
