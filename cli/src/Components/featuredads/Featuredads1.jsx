              ...
              md:space-y-5"
                ...
                uppercase inline-block"
                  ...
                  <a className="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl">
                    In Rudraksh Group We Provide Facility Management Services
                  </a>
            ...
            <div className="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
              ...
              rounded-full uppercase inline-block"
                ...
                <p className="text-sm text-black">
                  We offer top-quality housekeeping services to our clients. Our
                  team comprises highly trained professionals who.
                </p>
              </div>
              <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
                <img
              ...
              rounded-full uppercase inline-block"
                ...
                <p className="text-sm text-black">
                  Plumber Services is responsible for ensuring that your
                  residential or commercial property has efficient wastewater
                  disposal.
                </p>
              </div>
              <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
              ...
              rounded-full uppercase inline-block"
                ...
                <p className="text-sm text-black">
                  Electricians are experts in handling electrical systems, be it
                  in homes, businesses, or industrial environments.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
              ...
              <div className="md:7/12 lg:w-6/12">
                ...
                <p className="mt-6 text-gray-600">
                  We dedicate ourselves to delivering premium cleaning services
                  tailored to your home or office. Our team of housekeepers is
                  devoted to surpassing expectations with pride. Offering
                  cost-effective rates,
                </p>
                <p className="mt-4 text-gray-600">
                  {" "}
                  We started by offering specialized services and evolved to
                  provide complete Integrated Facilities Services.
                </p>
              </div>
            </div>
          </div>
