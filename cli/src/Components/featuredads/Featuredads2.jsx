            ...
            <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
              ...
              <div className="md:7/12 lg:w-6/12">
                ...
                <p className="mt-6 text-gray-600">
                  Welcome to RG Shine your ultimate destination for premium home
                  cleaning solutions. At RG Shine we believe that a clean home
                  is the foundation of a healthy and happy life. That’s why
                  we’ve curated a comprehensive collection of top-quality
                  cleaning products to help you maintain a sparkling clean
                  environment effortlessly.
                </p>
                <p className="mt-4 text-gray-600">
                  {" "}
                  Our mission is simple: to provide you with the finest
                  selection of home cleaner products that deliver exceptional
                  results while minimizing environmental impact. We carefully
                  source our products from trusted brands known for their
                  effectiveness, safety, and commitment to sustainability.
                </p>
              </div>
            </div>
          </div>
