...
function Paymentform3() {
  ...
  const [baseAmount, setBaseAmount] = useState(5999);
  const gstRate = 0.18;
    ...
    <div className="container mx-auto bg-gray-100 p-6">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center px-10 py-4">
          <h4 className="font-bold">Social Media Marketing - 30 Days Plan</h4>
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center px-10 py-2">
          ...
          <h4 className="text-green-500">
            {" "}
            ₹{((baseAmount + baseAmount * gstRate) * discountRate).toFixed(2)}
          </h4>
        </div>
        {/* <div className="flex justify-between items-center px-10 py-2">
          <p>
