    ...
    <div className="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
        ...
        <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
                ...
                <h3 className="mt-2 text-2xl sm:text-left md:text-4xl">Rudraksh Group</h3>
                <p className="mt-5 text-lg text-gray-700 text md:text-left">We dedicate ourselves to delivering premium cleaning services tailored to your home or office. Our team of housekeepers is devoted to surpassing expectations with pride. Offering cost-effective rates, our skilled housekeepers deliver comprehensive and reliable services.</p>
            </div>
        </div>
        <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
