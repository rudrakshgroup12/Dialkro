      ...
      <div class="flex items-center align-center justify-center flex-wrap  p-6 space-x-6 bg-white rounded-xl shadow-lg  ">
        ...
        <div className="flex">
          <h1 className="text-center display-inline text-4xl font-bold mx-5">
            Grow Your <span className="text-red-700">Businesses</span> With Use
          </h1>
        </div>
      </div>
        ...
        >
          <div className="carousel-inner border rounded-lg">
            <div className="carousel-item active">
              <img src={facility} className="d-block w-100 border rounded-lg" />
            </div>
...
{/* <Popup show={showPopup} onClose={handleClosePopup} /> */}
        ...
        <div className="my-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 flex gap-3 lg:flex-justify lg:flex flex-col lg:flex-row">
          <div className="sm:text-center lg:text-left">
            ...
            <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 dark:text-white">
              ...
              businesses have the potential to reach maximum audience. We are on
              a high aim to provide all small and medium enterprises a
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
          <div class="rounded overflow-hidden shadow-lg">
            ...
            <div class="relative">
              ...
              <a href="#!">
                <div class="absolute bottom-0 left-0 bg-red-600 px-4 py-2 text-white text-sm hover:bg-white hover:text-red-600 transition duration-500 ease-in-out">
                  Free
                </div>
              </a>
            </div>
            <div class="px-6 py-4">
              <Link
                to="/feature"
                class="font-semibold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out"
              >
                DR. ASHISH GARG (Critical Care Medicine)
              </Link>
              <p class="text-gray-500 text-sm">Chandigarh city</p>
              <div className="flex">
            ...
            <div class="px-6 py-4 flex flex-row items-center">
              ...
              >
                <span class="ml-1">4 Month ago</span>
              </span>
            </div>
          </div>
          <div class="rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 py-4 flex flex-row items-center">
              ...
              >
                <span class="ml-1">1 Year Plans</span>
              </span>
            </div>
          </div>
          <div class="rounded overflow-hidden shadow-lg">
      ...
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div id="carouselExampleIndicators" className="carousel slide">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                  ...
                  <div class="rounded overflow-hidden shadow-lg flex flex-col ">
                    ...
                    <div class="px-6 py-4 mb-auto">
                      <Link
                        to="/article1"
                        class="font-bold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out inline-block mb-2"
                      >
          ...
          <button
            class="carousel-control-next car-next"
            type="button"
            data-bs-target="#carouselExampleIndicators"
            data-bs-slide="next"
          >
              ...
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    ...
                    services/products. We'll review your submission promptly and
                    contact you if any further information is needed. Thank you
                    for choosing Dialkro!
                  </p>
                  <div className="mt-6">
                    <Link
              ...
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    ...
                    assured, if any additional details are required, we'll reach
                    out to you promptly. Thank you for choosing Dialkro—we look
                    forward to potentially featuring your business in our
                    directory
                  </p>
                  <div className="mt-6">
                    <Link
              ...
              <div class="flex flex-wrap items-center md:flex-row flex-col-reverse">
                <div class="md:w-2/3 w-full pb-6 md:pb-0 md:pr-6 flex-col md:block flex items-center justify-center md:pt-0 pt-4">
                  <div>
                    <h1
                      role="heading"
                      class="text-xl md:text-2xl lg:text-4xl xl:text-4xl lg:w-10/12 text-white font-black leading-6 lg:leading-10 md:text-left text-center mb-12"
                    >
