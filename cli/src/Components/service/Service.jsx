        ...
        <div className="lg:grid lg:grid-cols-2">
            <div className="py-24 px-10 lg:px-0 max-w-3xl lg:max-w-md mx-auto">
                <h2 className="text-4xl tracking-tight font-extrabold text-gray-100">
                    <span className="block">Empowering Your Digital Presence with Expert Web Development and Graphic Design Solutions</span>
            ...
            <div className="lg:relative lg:mt-16">
                <img className="lg:absolute lg:inset-0 h-60 w-full lg:h-full object-cover object-center lg:rounded-tl-md" src={dialkroservice} alt="Woman workcation on the beach"/>
            </div>
        </div>
    </div>
