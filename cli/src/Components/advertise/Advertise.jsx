          ...
          <div className="flex">
            <div className="flex-shrink-0">
              <div className="flex items-center justify-center w-12 h-12 rounded-md">
                <svg xmlns="https://akam.cdn.jdmagicbox.com/images/icontent/listingbusiness/SearchVisibility_f.svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor"
            ...
            <div className="ml-4">
              <h4 className="text-lg font-medium leadi ">Premium Listing</h4>
              <p className="mt-2 ">Get higher visibility and exposure on Dialkro</p>
            </div>
          </div>
          <div className="flex">
            <div className="flex-shrink-0">
              <div className="flex items-center justify-center w-12 h-12 rounded-md">
                ...
                <img src={featuresecond} alt="" /></div>
            </div>
            <div className="ml-4">
              <h4 className="text-lg font-medium leadi ">Category Banner</h4>
              <p className="mt-2 ">Feature your business at the top of category searches</p>
            </div>
          </div>
          <div className="flex">
            <div className="flex-shrink-0">
              <div className="flex items-center justify-center w-12 h-12 rounded-md">
                ...
                <img src={featurethird} alt="" /></div>
            </div>
            <div className="ml-4">
              <h4 className="text-lg font-medium leadi ">Verified Seal</h4>
              <p className="mt-2 ">Verify your business listing on Justdial and improve your credibility</p>
            </div>
          </div>
          <div className="flex">
            <div className="flex-shrink-0">
              <div className="flex items-center justify-center w-12 h-12 rounded-md">
                ...
                <img src={featureforth} alt="" /></div>
            </div>
            <div className="ml-4">
              <h4 className="text-lg font-medium leadi ">Trust Stamp </h4>
              <p className="mt-2 ">Become eligible for a Trust Stamp that indicates your business is trustworthy</p>
            </div>
          </div>
          <div className="flex">
            <div className="flex-shrink-0">
              <div className="flex items-center justify-center w-12 h-12 rounded-md">
                ...
                <img src={featurefive} alt="" /></div>
            </div>
            <div className="ml-4">
              <h4 className="text-lg font-medium leadi ">Online Catalogue </h4>
              <p className="mt-2 ">Showcase your product and service offerings to potential customers</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex">
            <div className="flex-shrink-0">
              <div className="flex items-center justify-center w-12 h-12 rounded-md">
                ...
                <img src={featuresix} alt="" /></div>
            </div>
            <div className="ml-4">
              <h4 className="text-lg font-medium leadi ">Transaction Enabled Website</h4>
              <p className="mt-2 ">Get a professional looking website with your own domain.</p>
            </div>
          </div>
          <div className="flex">
            <div className="flex-shrink-0">
            ...
            <div className="ml-4">
              <h4 className="text-lg font-medium leadi ">Payment Solutions</h4>
              <p className="mt-2 ">Send and receive money from suppliers and customers</p>
            </div>
          </div>
          <div className="flex">
            <div className="flex-shrink-0">
            ...
            <div className="ml-4">
              <h4 className="text-lg font-medium leadi ">Smart Lead Management System</h4>
              <p className="mt-2 ">View and track all your leads at one place experience.</p>
            </div>
          </div>
          <div className="flex">
            <div className="flex-shrink-0">
            ...
            <div className="ml-4">
              <h4 className="text-lg font-medium leadi ">Competitor Analysis </h4>
              <p className="mt-2 ">Understand how your competitors are performing on Dialkro</p>
            </div>
          </div>
          <div className="flex">
            <div className="flex-shrink-0">
            ...
            <div className="ml-4">
              <h4 className="text-lg font-medium leadi ">Premium Customer Support </h4>
              <p className="mt-2 ">Guided onboarding experience with priority assistance</p>
            </div>
          </div>
        </div>
      </div>
...
<div className="my-6">
    <div
        className="rounded-t-2xl bg-red-600/80  w-full cursor-pointer select-none border-2 border-red-600/30 px-4 py-4 text-gray-100 transition duration-300 hover:border-red-600/80 hover:text-white">
        <h4 className="text-lg font-medium">How do I create an account on the website?</h4>
    </div>
    <div
        className="inline-flex w-full rounded-b-2xl border-x-2 border-b-2 border-dashed border-red-600/30 bg-red-100/50 px-4 py-4 text-red-800">
        <h5>
...
<div className="my-6">
    <div
        className="rounded-t-2xl bg-red-600/80 w-full cursor-pointer select-none border-2 border-red-600/30 px-4 py-4 text-gray-100 transition duration-300 hover:border-teal-600/80 hover:text-white">
        <h4 className="text-lg font-medium">What benefits will I get from a paid listing on Dialkro?</h4>
    </div>
    <div
        className="inline-flex w-full rounded-b-2xl border-x-2 border-b-2 border-dashed border-red-600/30 bg-red-100/50 px-4 py-4 text-red-800">
        <h5>Dialkro is India's No. 1 local Business directory  engine. A paid listing makes your business more visible to customers. It makes it easier for you to reach your goals and grow faster.
        </h5>
    </div>
</div>
...
<div className="my-6">
    <div
        className="rounded-t-2xl bg-red-600/80 w-full cursor-pointer select-none border-2 border-red-600/30 px-4 py-4 text-gray-100 transition duration-300 hover:border-red-600/80 hover:text-white">
        <h4 className="text-lg font-medium">What are advantage of advertisement for our business online?</h4>
    </div>
    <div
        className="inline-flex w-full rounded-b-2xl border-x-2 border-b-2 border-dashed border-red-600/30 bg-red-100/50 px-4 py-4 text-red-800">
        <h5>
...
<div className="my-6">
    <div
        className="rounded-t-2xl bg-red-600/80 w-full cursor-pointer select-none border-2 border-red-600/30 px-4 py-4 text-gray-100 transition duration-300 hover:border-red-600/80 hover:text-white">
        <h4 className="text-lg font-medium"> What is the best way to get leads for a small business?</h4>
    </div>
    <div
        className="inline-flex w-full rounded-b-2xl border-x-2 border-b-2 border-dashed border-red-600/30 bg-red-100/50 px-4 py-4 text-red-800">
        <h5>
        Cold emailing, social media marketing, and content marketing are some of the best ways to generate leads for a small business.
...
<div className="my-6">
    <div
        className="rounded-t-2xl bg-red-600/80 w-full cursor-pointer select-none border-2 border-red-600/30 px-4 py-4 text-gray-100 transition duration-300 hover:border-red-600/80 hover:text-white">
        <h4 className="text-lg font-medium">  How can I generate leads for a local business?</h4>
    </div>
    <div
        className="inline-flex w-full rounded-b-2xl border-x-2 border-b-2 border-dashed border-red-600/30 bg-red-100/50 px-4 py-4 text-red-800">
        <h5>
        You can use local SEO, engage with the community, leverage online directories, and consider partnerships with other local businesses for effective lead generation.
