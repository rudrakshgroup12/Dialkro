...
function Home() {
  ...
  return (
    <div className={isDarkMode ? "dark" : ""}>
      ...
      <div class="flex items-center align-center justify-center flex-wrap  p-6 space-x-6 bg-white rounded-xl shadow-lg  ">
      <div class="flex bg-gray-100 p-4 w-72 space-x-4 rounded-lg ">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 opacity-30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
        </svg>
        <input className="bg-gray-100 outline-none " type="text" placeholder="Search Your Business " />
    ...
    Grow Your <span className="text-red-700">Businesses</span> With Use</h1>
    </div>
   ...
   <div id="carouselExample" className="carousel slide w-50  m-10 maincarousel border rounded-lg">
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-red-800 rounded-lg max-w-xs shadow-lg group">
    <svg className="absolute bottom-0 left-0 mb-8 scale-150 group-hover:scale-[1.65] transition-transform opacity-10"
        viewBox="0 0 375 283" fill="none" >
        <rect x="159.52" y="175" width="152" height="152" rx="8" transform="rotate(-45 159.52 175)" fill="white" />
        <rect y="107.48" width="152" height="152" rx="8" transform="rotate(-45 0 107.48)" fill="white" />
    </svg>
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        <div className="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3 busicard">
        </div>
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/web2022/resfilter_orderfood.svg?w=64&q=75" alt=""/>
    </div>
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-teal-800 rounded-lg max-w-xs shadow-lg group ">
    <svg className="absolute bottom-0 left-0 mb-8 scale-150 group-hover:scale-[1.65] transition-transform opacity-10" viewBox="0 0 375 283" fill="none"
      >
        <rect x="159.52" y="175" width="152" height="152" rx="8" transform="rotate(-45 159.52 175)" fill="white" />
        <rect y="107.48" width="152" height="152" rx="8" transform="rotate(-45 0 107.48)" fill="white" />
    </svg>
...
>
        ...
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icons/newwap/newhotkey/hotel-2022.svg?w=48&q=75" alt=""/>
    </div>
    <div className="relative text-white px-6 pb-6 mt-6">
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-orange-800 rounded-lg max-w-xs shadow-lg group ">
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icons/newwap/newhotkey/beauty.svg?w=48&q=75" alt=""/>
    </div>
    <div className="relative text-white px-6 pb-6 mt-6">
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-orange-800 rounded-lg max-w-xs shadow-lg group ">
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icons/iphone/new/icd-hl-pediatric-urology-counselling.png?w=96&q=75" alt=""/>
    </div>
    <div className="relative text-white px-6 pb-6 mt-6">
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-purple-800 rounded-lg max-w-xs shadow-lg group ">
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <img className="relative w-20" src="https://images.jdmagicbox.com/standard/shopfront/c735afc2f5ad3be2ea1b2e963496c75a.png" alt=""/>
    </div>
    <div className="relative text-center text-white px-6 pb-6 mt-6">
       
        <div class="flex justify-between">
            <span class="block font-bold text-xl">Wedding </span>
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-red-800 rounded-lg max-w-xs shadow-lg group ">
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icons/iphone/new/icd-hl-aerobics.png?w=96&q=75" alt=""/>
    </div>
    <div className="relative text-white px-6 pb-6 mt-6">
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-green-800 rounded-lg max-w-xs shadow-lg group ">
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icons/newwap/newhotkey/pg-hostels-rooms.svg?w=48&q=75" alt=""/>
    </div>
    <div className="relative text-white px-6 pb-6 mt-6">
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-pink-800 rounded-lg max-w-xs shadow-lg group ">
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icons/newwap/newhotkey/estate-agent.svg?w=48&q=75" alt=""/>
    </div>
    <div className="relative text-white px-6 pb-6 mt-6">
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-pink-300 rounded-lg max-w-xs shadow-lg group ">
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icons/newwap/newhotkey/packers_movers_2023.svg?w=48&q=75" alt=""/>
    </div>
    <div className="relative text-white px-6 pb-6 mt-6">
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-yellow-800 rounded-lg max-w-xs shadow-lg group ">
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icons/newwap/newhotkey/eventorganizers.svg?w=48&q=75" alt=""/>
    </div>
    <div className="relative text-white px-6 pb-6 mt-6">
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-green-600 rounded-lg max-w-xs shadow-lg group ">
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icons/newwap/newhotkey/furniture.svg?w=32&q=75" alt=""/>
    </div>
    <div className="relative text-white px-6 pb-6 mt-6">
...
<div className="flex-shrink-0 m-6 relative overflow-hidden bg-blue-800 rounded-lg max-w-xs shadow-lg group ">
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <img className="relative w-20" src="https://akam.cdn.jdmagicbox.com/images/icons/newwap/newhotkey/carrepairservices.svg?w=32&q=75" alt=""/>
    </div>
    <div className="relative text-white px-6 pb-6 mt-6">
...
<div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
          <h1 className="text-5xl font-bold mb-10">Popular and <span className="text-red-800">Featured Ads</span></h1>
    <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
        <div class="rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 py-4">
                ...
                <Link to="/feature"
                    class="font-semibold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out">DR. ASHISH GARG (Critical Care Medicine)</Link>
        ...
        <div class="rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 py-4">
                ...
                <Link to="/featured1"
                    class="font-semibold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out">Mr. Prem maurya</Link>
                <p class="text-gray-500 text-sm">
        ...
        <div class="rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 py-4">
                ...
                <Link to="/featured2"
                    class="font-semibold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out">Ms. SADHANA MAURYA</Link>
                <p class="text-gray-500 text-sm">
      ...
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        <h1 className="font-bold text-black text-2xl my-10">Related Articles</h1>
...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
        ...
        <div class="rounded overflow-hidden shadow-lg flex flex-col ">
            ...
            <div class="px-6 py-4 mb-auto">
                <Link to="/article1"
                    class="font-bold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out inline-block mb-2">Colleges in India with the Most Beautiful Campuses and Best Architecture</Link>
            
            </div>
            <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                   
                    <span  class="ml-1">Best Collages</span>
                </span>
                ...
                <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                    ...
                    <Link to="/article1" class="ml-1">Explore Now</Link>
                </span>
            </div>
        </div>
        ...
        <div class="rounded overflow-hidden shadow-lg flex flex-col">
            ...
            <div class="px-6 py-4 mb-auto">
                <Link to="/article2"
                    class="font-bold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out inline-block mb-2">Leading the Fight: Top Cancer Hospitals in India Pioneering Advanced Care </Link>
                
            </div>
            <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                   
                    <span class="ml-1">Explore now</span>
                </span>
                ...
                <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                    ...
                    <span class="ml-1">Best Hospitals</span>
                </span>
            </div>
        </div>
        ...
        <div class="rounded overflow-hidden shadow-lg flex flex-col">
            ...
            <div class="px-6 py-4 mb-auto">
                <Link to="/article3"
                    class="font-bold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out inline-block mb-2">National Reading Day 2024: Top Bookstores in India to Explore the World of Rabindranath Tagore</Link>
            ...
            <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                ...
                <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                    ...
                    <span class="ml-1">Book Store</span>
                </span>
            </div>
        </div>
   ...
   <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
    ...
    <div class="rounded overflow-hidden shadow-lg flex flex-col">
        ...
        <div class="px-6 py-4 mb-auto">
            <Link to="/article4"
                class="font-bold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out inline-block mb-2">Engineer's Day: Celebrating the Innovations and Creativity of the Universal Problem Solvers</Link>
        ...
        <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
            ...
            <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                ...
                <span class="ml-1">IIT Collages</span>
            </span>
        </div>
    </div>
    ...
    <div class="rounded overflow-hidden shadow-lg flex flex-col">
        ...
        <div class="px-6 py-4 mb-auto">
            <Link to="/article5"
                class="font-bold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out inline-block mb-2">Top 5 Restuarent In  Chandigarh </Link>
        ...
        <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
            ...
            <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                ...
                <span class="ml-1">Restuarent</span>
            </span>
        </div>
    </div>
    ...
    <div class="rounded overflow-hidden shadow-lg flex flex-col">
        ...
        <div class="px-6 py-4 mb-auto">
            <Link to="/article6"
                class="font-bold text-lg inline-block hover:text-red-600 transition duration-500 ease-in-out inline-block mb-2">Mighty Mangoes: Must Visit Places with Special Mango Menu in Mumbai</Link>
 ...
 <button className="carousel-control-prev car-nex" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
    <span class="carousel-control-prev-icon bg-black" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
  </button>
  <button class="carousel-control-next car-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
        ...
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
         ...
         <div class="mx-auto container py-12 px-4">
            <div class="w-full flex justify-center">
                <div class="w-full md:w-11/12 xl:w-10/12 bg-gradient-to-r from-red-500 to-red-800 md:py-8 md:px-8 px-5 py-4 xl:px-12 xl:py-16">
                    <div>
                        <div class="flex flex-wrap items-center md:flex-row flex-col-reverse">
                            <div class="md:w-2/3 w-full pb-6 md:pb-0 md:pr-6 flex-col md:block flex items-center justify-center md:pt-0 pt-4">
                                <div >
                                    <h1 role="heading" class="text-xl md:text-2xl lg:text-4xl xl:text-4xl lg:w-10/12 text-white font-black leading-6 lg:leading-10 md:text-left text-center mb-12">Become a member and start building the next big thing</h1>
                                </div>
                                <Link to="/new" aria-label="Join the community" className="mt-5 lg:mt-8 py-3 lg:py-4 px-4 lg:px-8 bg-white font-bold text-red-700 rounded-lg text-sm lg:text-lg xl:text-xl hover:bg-opacity-90  focus:ring-2 focus:ring-offset-2 focus:ring-white focus:outline-none">Join the community</Link>
                            </div>
